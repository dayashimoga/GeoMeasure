...
class _MeasurementWizardPageState extends State<MeasurementWizardPage> {
  ...
  // Step 3: Dimensions
  final _lengthController = TextEditingController(text: '5.0');
  final _widthController = TextEditingController(text: '3.0');
  ...
  static const _shapes = [
    'Rectangle', 'Circle', 'Triangle', 'L-Shape', 'Irregular',
  ];
            ...
            content: Column(
              children: [
                ...
                SegmentedButton<DistanceUnit>(
                  segments: const [
                    ButtonSegment(
                        value: DistanceUnit.meters, label: Text('m')),
                    ButtonSegment(
                        value: DistanceUnit.feet, label: Text('ft')),
                    ButtonSegment(
            ...
            content: Card(
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    _ReviewRow('Mode', _selectedMode,
                        Icons.straighten_rounded),
                    _ReviewRow('Shape', _selectedShape,
                        Icons.crop_square_rounded),
                    _ReviewRow('Area',
                    ...
                    _ReviewRow('Unit', _selectedUnit.name,
                        Icons.tune_rounded),
  ...
  void _saveMeasurement() {
    sl.measurementProvider.calculateMeasurement(
      shape: RectangleShape(
        lengthMeters: double.tryParse(_lengthController.text) ?? 1,
        widthMeters: double.tryParse(_widthController.text) ?? 1,
      ),
